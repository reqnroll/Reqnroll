...
namespace Reqnroll.Configuration.AppConfig
{
    ...
    {
        public Configuration.ReqnrollConfiguration LoadAppConfig(Configuration.ReqnrollConfiguration reqnrollConfiguration, ConfigurationSectionHandler configSection)
        {
