...
namespace Reqnroll.Bindings
{
    ...
    public class StepDefinitionRegexCalculator : IStepDefinitionRegexCalculator
    {
        ...
        public StepDefinitionRegexCalculator(Configuration.ReqnrollConfiguration reqnrollConfiguration)
        {
        ...
        private IEnumerable<string> GetPrefixesToRemove(StepDefinitionType stepDefinitionType)
        {
            ...
            var cultureToSearch = reqnrollConfiguration.BindingCulture ?? reqnrollConfiguration.FeatureLanguage;
