...
public interface IObjectContainer : IDisposable
{
    ...
    /// <summary>
    /// Determines whether the interface or type is registered in the current container, optionally with the specified name.
    /// </summary>
    /// <typeparam name="T">The interface or type.</typeparam>
    ...
    /// <summary>
    /// Determines whether the interface or type is registered in the current container or base container(s), optionally with the specified name.
    /// </summary>
    /// <typeparam name="T">The interface or type.</typeparam>
    /// <param name="name">The name or <c>null</c>.</param>
    /// <returns><c>true</c> if the interface or type is registered; otherwise <c>false</c>.</returns>
