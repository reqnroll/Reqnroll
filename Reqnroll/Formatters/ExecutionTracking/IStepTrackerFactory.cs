...
{
    TestStepExecutionTracker CreateTestStepExecutionTracker(TestCaseExecutionTracker parentTracker, IMessagePublisher picklePublisher = null, IIdGenerator testStepIdGenerator = null);
