...
internal class MSTestCSharpTestFixtureSourceTextGenerator : CSharpTestFixtureSourceTextGenerator
{
    const string MSTestNamespace = "Microsoft.VisualStudio.TestTools.UnitTesting";

    public MSTestCSharpTestFixtureSourceTextGenerator(FeatureInformation featureInfo) : base(featureInfo)
    {
    }

    protected override IEnumerable<AttributeDescriptor> GetTestFixtureAttributes()
    {
        return base.GetTestFixtureAttributes().Concat(new[]
        {
