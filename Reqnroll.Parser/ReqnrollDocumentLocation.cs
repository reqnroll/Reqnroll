...
{
    public class ReqnrollDocumentLocation
    {
        public ReqnrollDocumentLocation(string sourceFilePath) : this(sourceFilePath, string.Empty)
        {}

        public ReqnrollDocumentLocation(string sourceFilePath, string featureFolderPath)
        {
