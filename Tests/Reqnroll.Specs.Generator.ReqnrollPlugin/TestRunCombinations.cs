...
namespace Reqnroll.Specs.Generator.ReqnrollPlugin
{
    public class TestRunCombinations
    {
        ...
        {
#if XUNIT_SPECS
            new Combination() {ProgrammingLanguage = "CSharp", ProjectFormat = "Old", TargetFramework = TfmEnumValuenet462, UnitTestProvider = "xUnit", ConfigFormat = "Json"},
            new Combination() {ProgrammingLanguage = "CSharp", ProjectFormat = "New", TargetFramework = TfmEnumValuenet462, UnitTestProvider = "xUnit", ConfigFormat = "Json"},
...
#if MSTEST_SPECS
            new Combination() {ProgrammingLanguage = "CSharp", ProjectFormat = "New", TargetFramework = TfmEnumValuenet462, UnitTestProvider = "MSTest", ConfigFormat = "Json"},
...
#if NUNIT_SPECS
            new Combination() {ProgrammingLanguage = "CSharp", ProjectFormat = "New", TargetFramework = TfmEnumValuenet462, UnitTestProvider = "NUnit3", ConfigFormat = "Json"},
