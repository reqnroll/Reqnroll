...
namespace Reqnroll.RuntimeTests.Bindings
{
    ...
    public class StepDefinitionRegexCalculatorTests
    {
        ...
        {
            return new StepDefinitionRegexCalculator(reqnrollConfiguration);
        }
        ...
        {
            reqnrollConfiguration.FeatureLanguage = new CultureInfo("de-AT", false);
            var sut = CreateSut();
        ...
        {
            reqnrollConfiguration.FeatureLanguage = new CultureInfo("ru", false);
            var sut = CreateSut();
