...
namespace Reqnroll.RuntimeTests.Infrastructure
{
    public class ReqnrollOutputHelperTests
    {
        ...
        private ReqnrollOutputHelper CreateReqnrollOutputHelper()
        {
            ...
            var config = new ReqnrollConfiguration(ConfigSource.Json, null, null, null, null, false, MissingOrPendingStepsOutcome.Error, false, false, TimeSpan.FromSeconds(10), Reqnroll.BindingSkeletons.StepDefinitionSkeletonStyle.CucumberExpressionAttribute, null, false, false, new string[] { }, true, ObsoleteBehavior.Error, false, null);
