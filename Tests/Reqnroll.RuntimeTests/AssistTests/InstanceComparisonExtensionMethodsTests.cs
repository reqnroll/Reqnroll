...
StringProperty: Expected <Howard Roark>, Actual <Peter Keating>, Using 'Reqnroll.Assist.ValueComparers.DefaultValueComparer'".AgnosticLineBreak());
        }
        ...
        public void Exception_returns_an_exception_for_two_errors_when_there_are_two_differences()
        {
            ...
            exception.Message.AgnosticLineBreak().Should().Be(
                @"The following fields did not match:
StringProperty: Expected <Howard Roark>, Actual <Peter Keating>, Using 'Reqnroll.Assist.ValueComparers.DefaultValueComparer'
IntProperty: Expected <1>, Actual <2>, Using 'Reqnroll.Assist.ValueComparers.DefaultValueComparer'".AgnosticLineBreak());
        }
