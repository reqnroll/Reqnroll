...
Scenario: {title}
        ...
        {
            _projectsDriver.AddFile("FeatureWithSingleFileGenerator.feature", "Feature: Feature File with SingleFileGenerator", "None", new Dictionary<string, string>(){{"Generator", "ReqnrollSingleFileGenerator"}});
        }
