...
Parameters of Scenario Outlines contained in multi-line text that are nested inside of XML are not handled properly - https://github.com/reqnroll/Reqnroll/issues/2571
