...
";
    ...
    [Fact]
    public void XUnit3TestGeneratorProvider_ExamplesFirstColumnIsDifferentAndMultipleColumns_ShouldSetDescriptionCorrectly()
    {
        // ARRANGE
...
";
    ...
    [Fact]
    public void XUnit3TestGeneratorProvider_ExampleIdentifier_ShouldSetInlineDataAttributesCorrectly()
    {
        // ARRANGE
...
";
    ...
    public void XUnit3TestGeneratorProvider_ShouldSetSkipAttributeForTheory()
    {
        ...
        // Assert
        var modifiedAttribute = codeMemberMethod.CustomAttributes.OfType<CodeAttributeDeclaration>()
                                                .FirstOrDefault(a => a.Name == XUnit3TestGeneratorProvider.THEORY_ATTRIBUTE);
    ...
    [Fact]
    public void XUnit3TestGeneratorProvider_ShouldInitializeTestOutputHelperFieldInConstructor()
    {
        // ARRANGE
        var document = ParseDocumentFromString(SampleFeatureFile);
        var provider = CreateSUTxunit3GeneratorProvider();
    ...
    [Fact]
    public void XUnit3TestGeneratorProvider_Should_add_testOutputHelper_field_in_class()
    {
        // ARRANGE
        var document = ParseDocumentFromString(SampleFeatureFile);
        var provider = CreateSUTxunit3GeneratorProvider();
    ...
    [Fact]
    public void XUnit3TestGeneratorProvider_Should_register_testOutputHelper_on_scenario_setup()
    {
        // ARRANGE
        var document = ParseDocumentFromString(SampleFeatureFile);
        var provider = CreateSUTxunit3GeneratorProvider();
    ...
    [Fact]
    public void XUnit3TestGeneratorProvider_WithFeatureWithMatchingTag_ShouldAddNonParallelizableCollectionAttribute()
    {
        // ARRANGE
    ...
    [Fact]
    public void XUnit3TestGeneratorProvider_WithFeatureWithNoMatchingTag_ShouldNotAddNonParallelizableCollectionAttribute()
    {
        // ARRANGE
        var document = ParseDocumentFromString(@"
            Feature: Sample feature file
    ...
    [Fact]
    public void XUnit3TestGeneratorProvider_ScenarioTagOnly_ShouldNotAddNonParallelizableCollectionAttribute()
    {
        // ARRANGE
        var document = ParseDocumentFromString(@"
            Feature: Sample feature file
