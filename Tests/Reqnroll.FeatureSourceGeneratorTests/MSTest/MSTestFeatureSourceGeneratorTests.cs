...
public class MSTestFeatureSourceGeneratorTests
{
    ...
    public void GeneratorProducesMSTestOutputWhenWhenBuildPropertyConfiguredForMSTest()
    {
        ...
        var generatedSyntaxRoot = generatedSyntaxTree.GetRoot();
        var generatedNamespace = generatedSyntaxRoot.Should().ContainSingleNamespaceDeclaration("test").Subject;
        var generatedClass = generatedNamespace.Should().ContainSingleClassDeclaration("CalculatorFeature").Subject;
        generatedClass.Should().HaveSingleAttribute("global::Microsoft.VisualStudio.TestTools.UnitTesting.TestClass");
    }
}
