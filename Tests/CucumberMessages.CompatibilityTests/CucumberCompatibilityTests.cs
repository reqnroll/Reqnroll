...
namespace CucumberMessages.CompatibilityTests
{
    ...
    {
        private void ResetCucumberMessages(string? fileToDelete = null)
        {
            DisableCucumberMessages();
            DeletePreviousMessagesOutput(fileToDelete);
        }

        private void DeletePreviousMessagesOutput(string? fileToDelete = null)
        {
        ...
        {
            ResetCucumberMessages("Cucumber Messages Smoke Test.ndjson");
        ...
        {
            ResetCucumberMessages("Cucumber Messages Smoke Test.ndjson");
            ResetCucumberMessages("Cucumber Messages Smoke Test Second Smoke Test.ndjson");
            EnableCucumberMessages();
            CucumberMessagesAddConfigurationFile("CucumberMessages.configuration.json");
