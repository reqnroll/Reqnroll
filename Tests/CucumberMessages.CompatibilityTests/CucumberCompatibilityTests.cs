...
namespace CucumberMessages.Tests
{
    ...
    public class CucumberCompatibilityTests : CucumberCompatibilityTestBase
    {
        ...
        [Ignore] // Ignoring for now as the pickles generated by the Gherkin pickle compiler include the Feature-level @retry tag; the CCK indicates that they should not have that tag
        [TestMethod]
